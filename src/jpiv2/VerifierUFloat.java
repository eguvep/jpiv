...
/**
 * Unsigned Float Input Verifier. Can be registered on an input component to
 * verify user input.
 * 
 */
public class VerifierUFloat extends InputVerifier {
	...
	public boolean verify(JComponent input) {
		...
		return (tf.getText().matches("^[0-9]+\\.?[0-9]*$"));
	}
